...
namespace  OCCubiquity{
    ...
    public class SubstrateIdToCubiquityColor : CBScriptableObject
    {
        ...
        public static void paintVolume(int id, Cubiquity.ColoredCubesVolumeData data, Color32 cubeColor, CBScriptableObject cbobject)
        {
        ...
        public static void paintVolume(Cubiquity.ColoredCubesVolumeData data, Color32 color, CBScriptableObject cbobject)
        {
            foreach (Point p in cbobject._cb3DpointsPlusId)
            {
                data.SetVoxel(p.x, p.y, p.z, (Cubiquity.QuantizedColor)color);
            }
        }
